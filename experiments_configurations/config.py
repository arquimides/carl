...
class DeepRLConf(AlgConf):
    def __init__(self, alg_name, combination_strategy, screen_width, screen_height,
                 ...
                 exploration_fraction, learning_start, train_frequency, rl_action_selection_strategy,
                 episode_state_initialization):
...
class RLConf(AlgConf):
    def __init__(self, alg_name, combination_strategy, n, alpha, gamma, epsilon_start, epsilon_end,
                 rl_action_selection_strategy, episode_state_initialization):
        super().__init__(alg_name, combination_strategy)
        self.n = n
...
class CRLConf(RLConf):
    def __init__(self, alg_name, combination_strategy, n, alpha, gamma, epsilon_start, epsilon_end,
                 rl_action_selection_strategy, episode_state_initialization, T, th, model_use_strategy,
                 model_discovery_strategy, min_frequency, crl_action_selection_strategy, use_crl_data,
                 model_init_path=None):
        super().__init__(alg_name, combination_strategy, n, alpha, gamma, epsilon_start, epsilon_end,
                         rl_action_selection_strategy, episode_state_initialization)
        self.T = T
        self.th = th
        self.model_use_strategy = model_use_strategy
...
class ExpConf:
    ...
    def __init__(self, exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps,
                 action_count_strategy, shared_initial_states, alg_confs):
...
combination_strategy_8 = CombinationStrategy("RLforCD and then CD and RL using CD forever",
                                             [single_stage_3, cycle_stage_9])
...
rl_conf_1 = RLConf("Q-Learning e0.3dec", combination_strategy_7, 0, 1, 0.95, 0.3, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_2 = RLConf("Q-Learning e0.7dec", combination_strategy_7, 0, 1, 0.95, 0.7, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_3 = RLConf("Q-Learning e1.0dec", combination_strategy_7, 0, 1, 0.95, 1.0, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_4 = RLConf("Q-Learning e0.1fix", combination_strategy_7, 0, 1, 0.95, 0.1, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)

# STOCHASTIC ENVIRONMENT WITH DECAYED EPSILON, alpha = 0.3
rl_conf_5 = RLConf("Q-Learning e0.3dec", combination_strategy_7, 0, 0.3, 0.95, 0.3, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_6 = RLConf("Q-Learning e0.7dec", combination_strategy_7, 0, 0.3, 0.95, 0.7, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_7 = RLConf("Q-Learning e1.0dec", combination_strategy_7, 0, 0.3, 0.95, 1.0, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)
rl_conf_8 = RLConf("Q-Learning e0.1fix", combination_strategy_7, 0, 0.3, 0.95, 0.1, 0.1,
                   ActionSelectionStrategy.EPSILON_GREEDY, EpisodeStateInitialization.RANDOM)

# DETERMINISTIC ENVIRONMENT WITH FIXED EPSILON
rl_conf_9 = RLConf("Dyna Q n5", combination_strategy_7, 5, 1, 0.95, 0.1, 0.1, ActionSelectionStrategy.EPSILON_GREEDY,
                   EpisodeStateInitialization.RANDOM)
rl_conf_10 = RLConf("Dyna Q n10", combination_strategy_7, 10, 1, 0.95, 0.1, 0.1, ActionSelectionStrategy.EPSILON_GREEDY,
                    EpisodeStateInitialization.RANDOM)
rl_conf_11 = RLConf("Dyna Q n20", combination_strategy_7, 20, 1, 0.95, 0.1, 0.1, ActionSelectionStrategy.EPSILON_GREEDY,
                    EpisodeStateInitialization.RANDOM)
rl_conf_12 = RLConf("Dyna Q n50", combination_strategy_7, 50, 1, 0.95, 0.1, 0.1, ActionSelectionStrategy.EPSILON_GREEDY,
                    EpisodeStateInitialization.RANDOM)
...
for env_type in EnvironmentType:
    ...
    crl_conf_go = CRLConf("CRL-T{}_GO".format(T), combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                          rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                          EpisodeStateInitialization.EPISODE_NUMBER,
                          T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.RANDOM, 0,
                          ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_gu = CRLConf("CRL-T{}-GU".format(T), combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                          rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                          EpisodeStateInitialization.EPISODE_NUMBER,
                          T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.GU, 0,
                          ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_bc = CRLConf("CRL-T{}-BC".format(T), combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                          rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                          EpisodeStateInitialization.EPISODE_NUMBER,
                          T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.BC, 0,
                          ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_dc = CRLConf("CRL-T{}-DC".format(T), combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                          rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                          EpisodeStateInitialization.EPISODE_NUMBER,
                          T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.DC, 0,
                          ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    # One time run experiment to make a full exploration to discover the underlying Ground Truths for each action
    experiment = ExpConf("Ground Truth search", EnvironmentNames.COFFEE, env_type, TRIALS, 10,
                         EvaluationMetric.EPISODE_REWARD, 5000, 10, ActionCountStrategy.Original, False,
                         [crl_conf_go, crl_conf_gu, crl_conf_bc, crl_conf_dc])
...
for env_type in EnvironmentType:
    ...
    for T in T_VALUES:
        pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_0, rl_params.n, rl_params.alpha,
                           rl_params.gamma, rl_params.epsilon_start, rl_params.epsilon_end,
                           rl_params.rl_action_selection_strategy, rl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.EPSILON_GREEDY,
                           MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                            crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                            crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                            ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                            ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
        experiment = ExpConf("RL vs RLforCD T{} th{}".format(T, 0.7), EnvironmentNames.COFFEE, env_type, TRIALS, 1,
                             EvaluationMetric.EPISODE_REWARD, 600, 25, ActionCountStrategy.Original, True,
                             [pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        ...
        model_free_rl = RLConf("Q-Learning", combination_strategy_7, rl_params.n, rl_params.alpha, rl_params.gamma,
                               rl_params.epsilon_start, rl_params.epsilon_end, rl_params.rl_action_selection_strategy,
                               rl_params.episode_state_initialization)
        model_based_rl = RLConf("Dyna Q n20", combination_strategy_7, 20, rl_params.alpha, rl_params.gamma,
                                rl_params.epsilon_start, rl_params.epsilon_end, rl_params.rl_action_selection_strategy,
                                rl_params.episode_state_initialization)
        pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_0, crl_params.n, crl_params.alpha,
                           crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                           crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.IMMEDIATE_POSITIVE, ModelDiscoveryStrategy.EPSILON_GREEDY,
                           MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                            crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                            crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
        ...
        # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
        experiment = ExpConf("CARL T{} vs RL e{}dec th{}".format(T, crl_params.epsilon_start, 0.7),
                             EnvironmentNames.COFFEE, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600, 25,
                             ActionCountStrategy.Original, True, [model_free_rl, model_based_rl, pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for T in T_VALUES:
        ...
        experiment = ExpConf("CARL T{} vs RL e{}dec".format(T, crl_params.epsilon_start), EnvironmentNames.COFFEE,
                             env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600, 25,
                             ActionCountStrategy.Original, True, [model_free_rl, model_based_rl, pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        ...
        model_based_rl = RLConf("Dyna Q n20", combination_strategy_7, 20, rl_params.alpha, rl_params.gamma,
                                rl_params.epsilon_start, rl_params.epsilon_end, rl_params.rl_action_selection_strategy,
                                rl_params.episode_state_initialization)
        pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_9, crl_params.n, crl_params.alpha,
                           crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                           crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.IMMEDIATE_POSITIVE, ModelDiscoveryStrategy.EPSILON_GREEDY,
                           MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_8, crl_params.n, crl_params.alpha,
                            crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                            crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                            ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
        ...
        experiment = ExpConf("CARL T{} discover once use forever e{}dec".format(T, crl_params.epsilon_start),
                             EnvironmentNames.COFFEE, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600, 25,
                             ActionCountStrategy.Original, True, [model_free_rl, model_based_rl, pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        ...
        carl_conf_1 = CRLConf("CARL T{} C_1".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                              crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                              crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                              T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                              ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                              ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        carl_conf_2 = CRLConf("CARL T{} C_2".format(T), combination_strategy_9, crl_params.n, crl_params.alpha,
                              crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                              crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                              T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                              ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
        ...
        experiment = ExpConf("CARL T{} using C1 vs C2 e{}dec".format(T, crl_params.epsilon_start),
                             EnvironmentNames.COFFEE, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600, 25,
                             ActionCountStrategy.Original, True, [carl_conf_1, carl_conf_2])
...
for env_type in EnvironmentType:
    # CRL configurations where the combination strategy is always RLforCD, CD, Repeat and ModelDiscoveryStrategy is to perform allways the same action, also each episode start in a different consecutive state to cover all the cases
    crl_conf_south = CRLConf("CRL-T60_SOUTH", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                             rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                             EpisodeStateInitialization.EPISODE_NUMBER,
                             T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.SOUTH,
                             MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_north = CRLConf("CRL-T60-NORTH", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                             rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                             EpisodeStateInitialization.EPISODE_NUMBER,
                             T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.NORTH,
                             MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_east = CRLConf("CRL-T60-EAST", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                            rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                            EpisodeStateInitialization.EPISODE_NUMBER,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.EAST,
                            MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_west = CRLConf("CRL-T60-WEST", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                            rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                            EpisodeStateInitialization.EPISODE_NUMBER,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.WEST,
                            MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_pick = CRLConf("CRL-T60-PICK", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                            rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                            EpisodeStateInitialization.EPISODE_NUMBER,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.PICK,
                            MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    crl_conf_drop = CRLConf("CRL-T60-DROP", combination_strategy_6, rl_conf_1.n, rl_conf_1.alpha, rl_conf_1.gamma,
                            rl_conf_1.epsilon_start, rl_conf_1.epsilon_end, rl_conf_1.rl_action_selection_strategy,
                            EpisodeStateInitialization.EPISODE_NUMBER,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.DROP,
                            MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

    # One time run experiment to make a full exploration to discover the underlying Ground Truths for each action
    experiment = ExpConf("Ground Truth search", EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10,
                         EvaluationMetric.EPISODE_REWARD, 100000, 1, ActionCountStrategy.Original, False,
                         [crl_conf_drop, crl_conf_pick, crl_conf_south, crl_conf_north, crl_conf_east, crl_conf_west])
...
for env_type in EnvironmentType:
    ...
    experiment = ExpConf("Find best Model-free RL params", EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10,
                         EvaluationMetric.EPISODE_REWARD, 1000, 100, ActionCountStrategy.Relational, True, RL_CONFS)
...
for env_type in EnvironmentType:
    ...
    for T in T_VALUES:
        ...
        carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                            ...
                            ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
        # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
        experiment = ExpConf("RL vs RLforCD T{} th{}".format(T, 0.7), EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10,
                             EvaluationMetric.EPISODE_REWARD, 1000, 50, ActionCountStrategy.Relational, True,
                             [pgm_conf, carl_conf])
    ...
    for i in range(len(RL_CONFS)):
        for th in [0.01]:
            ...
            carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                                crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                                crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                                T, th, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                                ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                                ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)

            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("CARL T{} vs RL e{}dec th{}".format(T, crl_params.epsilon_start, th),
                                 EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD,
                                 1000, 50, ActionCountStrategy.Relational, True, [carl_conf])
...
for env_type in EnvironmentType:
    ...
    for T in T_VALUES:
        ...
        experiment = ExpConf("CARL T{} vs RL e{}dec".format(T, crl_params.epsilon_start), EnvironmentNames.TAXI_SMALL,
                             env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 1000, 50,
                             ActionCountStrategy.Relational, True, [model_free_rl, model_based_rl, pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        ...
        experiment = ExpConf("CARL T{} discover once use forever e{}dec".format(T, crl_params.epsilon_start),
                             EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 2000,
                             50, ActionCountStrategy.Relational, True,
                             [model_free_rl, model_based_rl, pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    # 100% Model
    carl_conf_100 = CRLConf("CARL-100%", combination_strategy_4, crl_params.n, crl_params.alpha, crl_params.gamma,
                            crl_params.epsilon_start, crl_params.epsilon_end, crl_params.rl_action_selection_strategy,
                            crl_params.episode_state_initialization,
                            T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                            ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                            ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, MODELS_PATH[env_type]["100"])
    # 75% Model
    carl_conf_75 = CRLConf("CARL-75%", combination_strategy_4, crl_params.n, crl_params.alpha, crl_params.gamma,
                           crl_params.epsilon_start, crl_params.epsilon_end, crl_params.rl_action_selection_strategy,
                           crl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                           ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                           ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, MODELS_PATH[env_type]["75"])
    # 50% Model
    carl_conf_50 = CRLConf("CARL-50%", combination_strategy_4, crl_params.n, crl_params.alpha, crl_params.gamma,
                           crl_params.epsilon_start, crl_params.epsilon_end, crl_params.rl_action_selection_strategy,
                           crl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                           ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                           ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, MODELS_PATH[env_type]["50"])
    # 25% Model
    carl_conf_25 = CRLConf("CARL-25%", combination_strategy_4, crl_params.n, crl_params.alpha, crl_params.gamma,
                           crl_params.epsilon_start, crl_params.epsilon_end, crl_params.rl_action_selection_strategy,
                           crl_params.episode_state_initialization,
                           T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                           ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, MIN_FREQUENCY,
                           ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, MODELS_PATH[env_type]["25"])

    experiment = ExpConf("Taxi big task CARL vs RL using partial models", EnvironmentNames.TAXI_BIG, env_type, TRIALS,
                         10, EvaluationMetric.EPISODE_REWARD, 2000, 100, ActionCountStrategy.Original, True,
                         [carl_conf_100, carl_conf_75, carl_conf_50, carl_conf_25, model_free_rl])
    ...
    for T in T_VALUES:
        for th in th_values:
            pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_0, rl_params.n, rl_params.alpha,
                               rl_params.gamma, rl_params.epsilon_start, rl_params.epsilon_end,
                               rl_params.rl_action_selection_strategy, rl_params.episode_state_initialization,
                               T, th, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.EPSILON_GREEDY,
                               MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                                crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                                crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                                ...
                                ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("RL vs RLforCD T{} th{}".format(T, th), EnvironmentNames.COFFEE, env_type, TRIALS, 1,
                                 EvaluationMetric.EPISODE_REWARD, 600, 25, ActionCountStrategy.Original, True,
                                 [pgm_conf, carl_conf])
    ...
    for T in T_VALUES:
        for th in th_values:
            ...
            carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                                ...
                                ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("RL vs RLforCD T{} th{}".format(T, th), EnvironmentNames.TAXI_SMALL, env_type, TRIALS,
                                 10, EvaluationMetric.EPISODE_REWARD, 1000, 50, ActionCountStrategy.Relational, True,
                                 [pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        for th in th_values:
            ...
            model_free_rl = RLConf("Q-Learning", combination_strategy_7, rl_params.n, rl_params.alpha, rl_params.gamma,
                                   rl_params.epsilon_start, rl_params.epsilon_end,
                                   rl_params.rl_action_selection_strategy, rl_params.episode_state_initialization)
            # model_based_rl = RLConf("Dyna Q n20", combination_strategy_7, 20, rl_params.alpha, rl_params.gamma, rl_params.epsilon_start, rl_params.epsilon_end, rl_params.rl_action_selection_strategy, rl_params.episode_state_initialization)
            # pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_0, crl_params.n, crl_params.alpha, crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end, crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
            #                     T, th, ModelUseStrategy.IMMEDIATE_POSITIVE, ModelDiscoveryStrategy.EPSILON_GREEDY, MIN_FREQUENCY, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            ...
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("CARL T{} vs RL e{}dec th{}".format(T, crl_params.epsilon_start, th),
                                 EnvironmentNames.COFFEE, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600,
                                 25, ActionCountStrategy.Original, True, [model_free_rl, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        for th in th_values:
            ...
            experiment = ExpConf("CARL T{} vs RL e{}dec th{}".format(T, crl_params.epsilon_start, th),
                                 EnvironmentNames.TAXI_SMALL, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD,
                                 1000, 50, ActionCountStrategy.Relational, True, [model_free_rl, carl_conf])
    ...
    for T in T_VALUES:
        for f in f_values:
            pgm_conf = CRLConf("PGM'22 T{}".format(T), combination_strategy_0, rl_params.n, rl_params.alpha,
                               ...
                               rl_params.rl_action_selection_strategy, rl_params.episode_state_initialization,
                               T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE, ModelDiscoveryStrategy.EPSILON_GREEDY,
                               f, ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                                crl_params.gamma, crl_params.epsilon_start, crl_params.epsilon_end,
                                crl_params.rl_action_selection_strategy, crl_params.episode_state_initialization,
                                T, 0.7, ModelUseStrategy.POSITIVE_OR_NOT_NEGATIVE,
                                ModelDiscoveryStrategy.LESS_SELECTED_ACTION_EPSILON_GREEDY, f,
                                ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("RL vs RLforCD T{} f{}".format(T, f), EnvironmentNames.COFFEE, env_type, TRIALS, 1,
                                 EvaluationMetric.EPISODE_REWARD, 600, 25, ActionCountStrategy.Original, True,
                                 [pgm_conf, carl_conf])
    ...
    for T in T_VALUES:
        for f in f_values:
            ...
            carl_conf = CRLConf("CARL T{}".format(T), combination_strategy_1, crl_params.n, crl_params.alpha,
                                ...
                                ActionSelectionStrategy.MODEL_BASED_EPSILON_GREEDY, True, None)
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("RL vs RLforCD T{} f{}".format(T, f), EnvironmentNames.TAXI_SMALL, env_type, TRIALS,
                                 10, EvaluationMetric.EPISODE_REWARD, 1000, 50, ActionCountStrategy.Relational, True,
                                 [pgm_conf, carl_conf])
...
for env_type in EnvironmentType:
    ...
    for i in range(len(RL_CONFS)):
        for f in f_values:
            ...
            # ExpConf(exp_name, env_name, env_type, trials, smooth, evaluation_metric, max_episodes, max_steps, alg_confs):
            experiment = ExpConf("CARL T{} vs RL e{}dec f{}".format(T, crl_params.epsilon_start, f),
                                 EnvironmentNames.COFFEE, env_type, TRIALS, 10, EvaluationMetric.EPISODE_REWARD, 600,
                                 25, ActionCountStrategy.Original, True, [model_free_rl, carl_conf])
...
cp = {"max_episodes": 50000, "max_steps": 1000,
...
for env_type in [EnvironmentType.DETERMINISTIC]:
    ...
    dqn_conf = DeepRLConf("DQN", combination_strategy=combination_strategy_7, rl_action_selection_strategy=ActionSelectionStrategy.EPSILON_GREEDY,
                          screen_width=cp["screen_width"], screen_height=cp["screen_height"],
                          learning_rate=cp["learning_rate"], buffer_size=cp["buffer_size"], gamma=cp["gamma"],
                          target_network_update_rate=cp["target_network_update_rate"],
                          target_network_update_frequency=cp["target_network_update_frequency"],
    ...
    carl_dqn_conf_1 = DeepCRLConf("CARL-DQN-C2", combination_strategy=combination_strategy_8, rl_action_selection_strategy=ActionSelectionStrategy.EPSILON_GREEDY,
                                  screen_width=cp["screen_width"], screen_height=cp["screen_height"],
                                  learning_rate=cp["learning_rate"], buffer_size=cp["buffer_size"], gamma=cp["gamma"],
                                  target_network_update_rate=cp["target_network_update_rate"],
                                  target_network_update_frequency=cp["target_network_update_frequency"],
    ...
    carl_dqn_conf_2 = DeepCRLConf("CARL-DQN-C1", combination_strategy=combination_strategy_1, rl_action_selection_strategy=ActionSelectionStrategy.EPSILON_GREEDY,
                                  screen_width=cp["screen_width"], screen_height=cp["screen_height"],
                                  learning_rate=cp["learning_rate"], buffer_size=cp["buffer_size"], gamma=cp["gamma"],
                                  target_network_update_rate=cp["target_network_update_rate"],
                                  target_network_update_frequency=cp["target_network_update_frequency"],
    ...
    pgm_dqn_conf = DeepCRLConf("PGM-DQN-C0", combination_strategy=combination_strategy_0,
    ...
    experiment = ExpConf("DQN vs CARL-DQN", EnvironmentNames.TAXI_ATARI_SMALL, env_type, TRIALS, 10,
                         EvaluationMetric.EPISODE_REWARD, cp["max_episodes"], cp["max_steps"], ActionCountStrategy.Relational, True, [dqn_conf])
