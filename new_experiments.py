...
def experiment():
    ...
    arg_game.add_argument("--name",
                          ...
                          default='our_gym_environments/TaxiAtariSmallEnv-v0',
    ...
    arg_alg.add_argument("--algorithm", choices=['carl-dqn', 'dqn', 'ddqn', 'adqn', 'mmdqn',
    ...
    arg_net = parser.add_argument_group('CARL parameters')
    arg_alg.add_argument("--stage-duration", type=int, default=30000,
                         help='Maximum number of steps T using the stage indicated in the combination strategy')
    arg_alg.add_argument("--frequency-value", type=int, default=30,
                         help='Number of times the agent needs to perform each action in a given state before random exploration ')
    ...
    # Settings
    if args.debug:
    #if True: # remove after debugging
    ...
    if args.load_path:
        ...
        # Fill replay memory with RL_FOR_CD dataset
